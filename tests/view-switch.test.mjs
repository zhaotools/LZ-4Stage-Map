...
test("sidebar switches between the six stage-map collections", () => {
  ...
  assert.match(pageSource, /<p className="site-subtitle">LZ-Map · 全球资产四阶段观察<\/p>/);
