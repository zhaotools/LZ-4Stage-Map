...
test("sidebar switches between the five stage-map collections", () => {
  ...
  assert.match(pageSource, /MARKET｜市场/);
  assert.match(pageSource, /SECTOR｜行业/);
  assert.match(pageSource, /LEADERS｜核心资产/);
  assert.match(pageSource, /MACRO｜宏观/);
  ...
  assert.match(pageSource, /hkSelected: \["HSI", "HSTECH", "700\.HK", "9988\.HK", "1810\.HK", "3690\.HK", "5\.HK", "1299\.HK", "388\.HK", "939\.HK", "941\.HK", "883\.HK", "1211\.HK", "16\.HK", "2\.HK", "1093\.HK"\]/);
